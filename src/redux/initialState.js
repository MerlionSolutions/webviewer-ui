...
export default {
  viewer: {
    ...
    toolButtonObjects: {
      ...
      AnnotationCreatePlaceholder: { dataElement: 'placeholderToolButton', title: 'annotation.rubberStamp', img: 'ic_annotation_stamp_black_24px', group: 'miscTools', showColor: 'active' },
